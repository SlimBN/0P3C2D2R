...
class AdminContact
{
     ...
     * Add message
     *
     * @param \WuCore\FrontBundle\Entity\Message $message
     * @return AdminContact
     */
    public function addMessage(\WuCore\FrontBundle\Entity\Message $message)
    {
     ...
     * @param \WuCore\FrontBundle\Entity\Message $message
     */
    public function removeMessage(\WuCore\FrontBundle\Entity\Message $message)
    {
     ...
     * Set handler
     *
     * @param \WuCore\FrontBundle\Entity\User $handler
     * @return AdminContact
     */
    public function setHandler(\WuCore\FrontBundle\Entity\User $handler = null)
    {
