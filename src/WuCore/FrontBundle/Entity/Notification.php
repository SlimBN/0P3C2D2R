...
class Notification
{
     ...
     * Add subscription
     *
     * @param \WuCore\FrontBundle\Entity\Subscription $subscription
     * @return Notification
     */
    public function addSubscription(\WuCore\FrontBundle\Entity\Subscription $subscription)
    {
     ...
     * @param \WuCore\FrontBundle\Entity\Subscription $subscription
     */
    public function removeSubscription(\WuCore\FrontBundle\Entity\Subscription $subscription)
    {
     ...
     * @return Notification
     */
    public function addUser(\WuCore\FrontBundle\Entity\User $user)
    {
        $this->user[] = $user;
     ...
     * @param \WuCore\FrontBundle\Entity\User $user
     */
    public function removeUser(\WuCore\FrontBundle\Entity\User $user)
    {
