 ...
 * @ORM\Entity(repositoryClass="WuCore\CentralBundle\Repository\BoardFolderRepository")
 * @ORM\Entity
 */
class BoardFolder
{
     ...
     * Set cover
     *
     * @param \WuCore\CentralBundle\Entity\Picture $cover
     * @return BoardFolder
     */
    public function setCover(\WuCore\CentralBundle\Entity\Picture $cover = null)
    {
        $this->cover = $cover;
