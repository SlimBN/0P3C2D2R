 ...
 * @ORM\Entity(repositoryClass="WuCore\CentralBundle\Repository\FeedbackRepository")
 * @ORM\Entity
 */
class Feedback
{
     ...
     * Set fixedBy
     *
     * @param \WuCore\CentralBundle\Entity\User $fixedBy
     * @return Feedback
     */
    public function setFixedBy(\WuCore\CentralBundle\Entity\User $fixedBy = null)
    {
